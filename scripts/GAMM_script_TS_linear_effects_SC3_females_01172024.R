...
###################################################### S-R effect only ##################################################
mod1 <- gamm(SC3logRS  ~ s(SC3ReproductiveFemales, k=4),
...
mod2 <- gamm(SC3logRS  ~ s(SC3ReproductiveFemales, k=4) + Ovig_female_CO,
             data = dat, correlation=corAR1())
#Model summaries
summary(mod2)
summary(mod2$gam)
...
###################################################### Add Pcod lag1 only ##################################################
mod3 <- gamm(SC3logRS  ~ s(SC3ReproductiveFemales, k=4) + Pcod_lag1,
             data = dat, correlation=corAR1())
#Model summaries
summary(mod3)
summary(mod3$gam)
...
###################################################### Add PCod_RA2 only ##################################################
mod4 <- gamm(SC3logRS  ~ s(SC3ReproductiveFemales, k=4) + PCod_RA2,
             data = dat, correlation=corAR1())
#Model summaries
summary(mod4)
summary(mod4$gam)
...
###################################################### Add PCod_RA3 only ##################################################
mod5 <- gamm(SC3logRS  ~ s(SC3ReproductiveFemales, k=4) + PCod_RA3,
             data = dat, correlation=corAR1())
#Model summaries
summary(mod5)
summary(mod5$gam)
...
###################################################### Add FHS lag 2 only ##################################################
mod6 <- gamm(SC3logRS  ~ s(SC3ReproductiveFemales, k=4) + FHS_lag2,
             data = dat, correlation=corAR1())
#Model summaries
summary(mod6)
summary(mod6$gam)
...
###################################################### Add FHS RA2 only ###################################################
mod7 <- gamm(SC3logRS  ~ s(SC3ReproductiveFemales, k=4) + FHS_RA2,
             data = dat, correlation=corAR1())
#Model summaries
summary(mod7)
summary(mod7$gam)
...
mod8 <- gamm(SC3logRS  ~ s(SC3ReproductiveFemales, k=4) + Pcod_lag1 + FHS_lag2,
             data = dat, correlation=corAR1())
#Model summaries
summary(mod8)
summary(mod8$gam)
...
mod9 <- gamm(SC3logRS  ~ s(SC3ReproductiveFemales, k=4) + PCod_RA2 + FHS_RA2,
             data = dat, correlation=corAR1())
#Model summaries
summary(mod9)
summary(mod9$gam)
...
mod10 <- gamm(SC3logRS  ~ s(SC3ReproductiveFemales, k=4) + NBT_3RA,
             data = dat, correlation=corAR1())
#Model summaries
summary(mod10)
summary(mod10$gam)
...
mod11 <- gamm(SC3logRS  ~ s(SC3ReproductiveFemales, k=4) + NBT_3yr_minTemp,
              data = dat, correlation=corAR1())
#Model summaries
summary(mod11)
summary(mod11$gam)
...
mod12 <- gamm(SC3logRS  ~ s(SC3ReproductiveFemales, k=4) + AO_RA2,
              data = dat, correlation=corAR1())
#Model summaries
summary(mod12)
summary(mod12$gam)
...
mod13 <- gamm(SC3logRS  ~ s(SC3ReproductiveFemales, k=4) + AO_RA3,
              data = dat, correlation=corAR1())
#Model summaries
summary(mod13)
summary(mod13$gam)
...
mod14 <- gamm(SC3logRS  ~ s(SC3ReproductiveFemales, k=4) + PDO_RA2,
              data = dat, correlation=corAR1())
#Model summaries
summary(mod14)
summary(mod14$gam)
...
mod15 <- gamm(SC3logRS  ~ s(SC3ReproductiveFemales, k=4) + PDO_RA3,
              data = dat, correlation=corAR1())
#Model summaries
summary(mod15)
summary(mod15$gam)
...
mod16 <- gamm(SC3logRS  ~ s(SC3ReproductiveFemales, k=4) + SST_May_July,
              data = dat, correlation=corAR1())
#Model summaries
summary(mod16)
summary(mod16$gam)
...
mod17 <- gamm(SC3logRS  ~ s(SC3ReproductiveFemales, k=4) + SE.wind,
              data = dat, correlation=corAR1())
#Model summaries
summary(mod17)
summary(mod17$gam)
...
mod18 <- gamm(SC3logRS  ~ s(SC3ReproductiveFemales, k=4) + NW.wind,
              data = dat, correlation=corAR1())
#Model summaries
summary(mod18)
summary(mod18$gam)
...
mod19 <- gamm(SC3logRS  ~ s(SC3ReproductiveFemales, k=4) + FHS_lag2 + Ovig_female_CO,
             data = dat, correlation=corAR1())
#Model summaries
summary(mod19)
summary(mod19$gam)
...
mod20 <- gamm(SC3logRS  ~ s(SC3ReproductiveFemales, k=4) + FHS_lag2 + Ovig_female_CO + PDO_RA3,
              data = dat, correlation=corAR1())
#Model summaries
summary(mod20)
summary(mod20$gam)
...
mod21 <- gamm(SC3logRS  ~ s(SC3ReproductiveFemales, k=4) + FHS_lag2 + Ovig_female_CO + AO_RA3,
              data = dat, correlation=corAR1())
#Model summaries
summary(mod21)
summary(mod21$gam)
...
mod22 <- gamm(SC3logRS  ~ s(SC3ReproductiveFemales, k=4) + FHS_lag2 + Ovig_female_CO + PDO_RA2,
              data = dat, correlation=corAR1())
#Model summaries
summary(mod22)
summary(mod22$gam)
...
mod23 <- gamm(SC3logRS  ~ s(SC3ReproductiveFemales, k=4) + FHS_lag2 + Ovig_female_CO + AO_RA2,
              data = dat, correlation=corAR1())
#Model summaries
summary(mod23)
summary(mod23$gam)
...
mod24 <- gamm(SC3logRS  ~ s(SC3ReproductiveFemales, k=4) + FHS_lag2 + Ovig_female_CO + SST_May_July,
              data = dat, correlation=corAR1())
#Model summaries
summary(mod24)
summary(mod24$gam)
...
mod25 <- gamm(SC3logRS  ~ s(SC3ReproductiveFemales, k=4) + FHS_lag2 + Ovig_female_CO + SE.wind,
              data = dat, correlation=corAR1())
#Model summaries
summary(mod25)
summary(mod25$gam)
...
mod26 <- gamm(SC3logRS  ~ s(SC3ReproductiveFemales, k=4) + FHS_lag2 + Ovig_female_CO + NW.wind,
              data = dat, correlation=corAR1())
#Model summaries
summary(mod26)
summary(mod26$gam)
...
mod27 <- gamm(SC3logRS  ~ s(SC3ReproductiveFemales, k=4) + FHS_lag2 + PDO_RA3,
              data = dat, correlation=corAR1())
#Model summaries
summary(mod27)
summary(mod27$gam)
...
mod28 <- gamm(SC3logRS  ~ s(SC3ReproductiveFemales, k=4) + FHS_lag2 + AO_RA3,
              data = dat, correlation=corAR1())
#Model summaries
summary(mod28)
summary(mod28$gam)
...
###################################################### Combine FHS lag 2, AO_RA2 + PDO_RA2 #####################################################
mod29 <- gamm(SC3logRS  ~ s(SC3ReproductiveFemales, k=4) + FHS_lag2 + PDO_RA2,
              data = dat, correlation=corAR1())
#Model summaries
summary(mod29)
summary(mod29$gam)
...
###################################################### Combine FHS lag 2, AO_RA2  #####################################################
mod30 <- gamm(SC3logRS  ~ s(SC3ReproductiveFemales, k=4) + FHS_lag2 + AO_RA2,
              data = dat, correlation=corAR1())
#Model summaries
summary(mod30)
summary(mod30$gam)
...
mod31 <- gamm(SC3logRS  ~ s(SC3ReproductiveFemales, k=4) + FHS_lag2 + SST_May_July,
              data = dat, correlation=corAR1())
#Model summaries
summary(mod31)
summary(mod31$gam)
...
mod32 <- gamm(SC3logRS  ~ s(SC3ReproductiveFemales, k=4) + FHS_lag2 + SE.wind,
              data = dat, correlation=corAR1())
#Model summaries
summary(mod32)
summary(mod32$gam)
...
mod33 <- gamm(SC3logRS  ~ s(SC3ReproductiveFemales, k=4) + FHS_lag2 + PDO_RA3 + AO_RA3,
              data = dat, correlation=corAR1())
#Model summaries
summary(mod33)
summary(mod33$gam)
...
###################################################### Combine FHS lag 2, AO_RA2 + PDO_RA2 #####################################################
mod34 <- gamm(SC3logRS  ~ s(SC3ReproductiveFemales, k=4) + FHS_lag2 + PDO_RA2 + AO_RA2,
              data = dat, correlation=corAR1())
#Model summaries
summary(mod34)
summary(mod34$gam)
...
write.csv(AICc_linear, "output/SC3_Mixed_GAM_linear_model_AICc_values.csv")


###################################################### Combine FHS lag 2, AO_RA2 + PDO_RA2 #####################################################
mod_test <- gamm(SC3logRS  ~ s(SC3ReproductiveFemales, k=4) + FHS_lag2 + PDO_RA2 + AO_RA2+ SST_May_July,
                 data = dat, correlation=corAR1())
#Model summaries
summary(mod_test)
