...
#########################################################################################################
par(mfrow=c(2,1),cex.lab=1.25,cex.axis=1.25,cex=1.25) #configure axis labels)
...
#legend(8,4e+08,c("Total EBS reproductive old shell females"),cex=1.25,col=c(1),pch=c(2))
#abline(h=0)
box()

title(xlab="Year")
title(ylab="EBS female abundance (millions)")
#title(main=" Reproductive female abundance by year")
