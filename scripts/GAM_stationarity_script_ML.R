...
AICc(mod1, mod2) ## mod 2 better by ~ 2 units
...
summary(mod4)
AICc(mod1, mod4) # almost the same
...
AICc(mod1restricted, mod5a, mod5b) # better w/ FHS - by a lot!
...
AICc(mod5a, mod7) # adding AO not helpful!
...
AICc(mod5a, mod8) # adding bottom temp only marginally better
...
AICc(mod5a, mod9b) # not surprisingly - not any better
...
AICc(mod5a, mod10) # quite an improvement to include PDO
