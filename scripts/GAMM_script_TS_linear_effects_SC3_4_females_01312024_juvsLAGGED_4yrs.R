...
dat <- read.csv("data/EBS_Crab_and_envar_data_full_extent_for_analysis_reducedTime_updated_juvLAG4.csv", row.names = 1) #Has 1982 female bairdi and corresponding juvenile and environmental data removed
...
write.csv(AICc_linear, "output/Mixed_GAM_linear_model_AICc_values_SC3_SC4_juv_lag4.csv")
