...
mod6a <- gam(logRS ~ s(ReproductiveFemales, k=4) + s(FHS_lag2, k=4) + s(SE.wind, k=4),
            data = dat)

summary(mod6a)
plot(mod6a, resid=T, pch=1, se=F, rug=F, pages=1) 

AICc(mod6, mod6a) # adding wind not helpful!
