...
dat <- read.csv("data/EBS_Crab_and_envar_data_full_extent_for_analysis_reducedTime.csv", row.names = 1) #Has 1982 female bairdi and corresponding juvenile and environmental data removed
...
###################################################### Add Pcod lag1 only ##################################################
mod3 <- gamm(logRS ~ s(ReproductiveFemales, k=4) + s(Pcod_lag1, k=4),
             data = dat, correlation=corAR1())
#Model summaries
summary(mod3)
summary(mod3$gam)
...
###################################################### Add PCod_RA2 only ##################################################
mod4 <- gamm(logRS ~ s(ReproductiveFemales, k=4) + s(PCod_RA2, k=4),
             data = dat, correlation=corAR1())
#Model summaries
summary(mod4)
summary(mod4$gam)
...
###################################################### Add PCod_RA3 only ##################################################
mod5 <- gamm(logRS ~ s(ReproductiveFemales, k=4) + s(PCod_RA3, k=4),
             data = dat, correlation=corAR1())
#Model summaries
summary(mod5)
summary(mod5$gam)
...
###################################################### Add FHS lag 2 only ##################################################
mod6 <- gamm(logRS ~ s(ReproductiveFemales, k=4) + s(FHS_lag2, k=4),
             data = dat, correlation=corAR1())
#Model summaries
summary(mod6)
summary(mod6$gam)
...
###################################################### Add FHS RA2 only ###################################################
mod7 <- gamm(logRS ~ s(ReproductiveFemales, k=4) + s(FHS_RA2, k=4),
             data = dat, correlation=corAR1())
#Model summaries
summary(mod7)
summary(mod7$gam)
...
mod8 <- gamm(logRS ~ s(ReproductiveFemales, k=4) + s(Pcod_lag1, k=4) + s(FHS_lag2, k=4),
             data = dat, correlation=corAR1())
#Model summaries
summary(mod8)
summary(mod8$gam)
...
mod9 <- gamm(logRS ~ s(ReproductiveFemales, k=4) + s(PCod_RA2, k=4) + s(FHS_RA2, k=4),
             data = dat, correlation=corAR1())
#Model summaries
summary(mod9)
summary(mod9$gam)
...
mod10 <- gamm(logRS ~ s(ReproductiveFemales, k=4) + s(NBT_3RA, k=4) ,
             data = dat, correlation=corAR1())
#Model summaries
summary(mod10)
summary(mod10$gam)
...
mod11 <- gamm(logRS ~ s(ReproductiveFemales, k=4) + s(NBT_3yr_minTemp, k=4) ,
              data = dat, correlation=corAR1())
#Model summaries
summary(mod11)
summary(mod11$gam)
...
mod12 <- gamm(logRS ~ s(ReproductiveFemales, k=4) + s(AO_RA2, k=4) ,
              data = dat, correlation=corAR1())
#Model summaries
summary(mod12)
summary(mod12$gam)
...
mod13 <- gamm(logRS ~ s(ReproductiveFemales, k=4) + s(AO_RA3, k=4) ,
              data = dat, correlation=corAR1())
#Model summaries
summary(mod13)
summary(mod13$gam)
...
mod14 <- gamm(logRS ~ s(ReproductiveFemales, k=4) + s(PDO_RA2, k=4) ,
              data = dat, correlation=corAR1())
#Model summaries
summary(mod14)
summary(mod14$gam)
...
mod15 <- gamm(logRS ~ s(ReproductiveFemales, k=4) + s(PDO_RA3, k=4) ,
              data = dat, correlation=corAR1())
#Model summaries
summary(mod15)
summary(mod15$gam)
...
mod16 <- gamm(logRS ~ s(ReproductiveFemales, k=4) + s(SST_May_July, k=4) ,
              data = dat, correlation=corAR1())
#Modl summaries
summary(mod16)
summary(mod16$gam)
...
mod17 <- gamm(logRS ~ s(ReproductiveFemales, k=4) + s(SE.wind, k=4) ,
              data = dat, correlation=corAR1())
#Model summaries
summry(mod17)
summary(mod17$gam)
...
mod18 <- gamm(logRS ~ s(ReproductiveFemales, k=4) + s(NE.wind, k=4) ,
              data = dat, correlation=corAR1())
#Model summaries
summary(mod18)
summary(mod18$gam)
...
mod19 <- gamm(logRS ~ s(ReproductiveFemales, k=4) + s(FHS_lag2, k=4) + s(Ovig_female_CO, k=4),
             data = dat, correlation=corAR1())
#Model summaries
summary(mod19)
summary(mod19$gam)
...
mod20 <- gamm(logRS ~ s(ReproductiveFemales, k=4) + s(FHS_lag2, k=4) + s(Ovig_female_CO, k=4)+ s(PDO_RA3, k=4),
              data = dat, correlation=corAR1())
#Model summaries
summary(mod20)
summary(mod20$gam)
...
mod21 <- gamm(logRS ~ s(ReproductiveFemales, k=4) + s(FHS_lag2, k=4) + s(Ovig_female_CO, k=4)+ s(AO_RA3, k=4),
              data = dat, correlation=corAR1())
#Model summaries
summary(mod21)
summary(mod21$gam)
...
mod22 <- gamm(logRS ~ s(ReproductiveFemales, k=4) + s(FHS_lag2, k=4) + s(Ovig_female_CO, k=4) + s(PDO_RA2, k=4),
              data = dat, correlation=corAR1())
#Model summaries
summary(mod22)
summary(mod22$gam)
...
mod23 <- gamm(logRS ~ s(ReproductiveFemales, k=4) + s(FHS_lag2, k=4) + s(Ovig_female_CO, k=4) + s(AO_RA2, k=4),
              data = dat, correlation=corAR1())
#Model summaries
summary(mod23)
summary(mod23$gam)
...
mod24 <- gamm(logRS ~ s(ReproductiveFemales, k=4) + s(FHS_lag2, k=4) + s(Ovig_female_CO, k=4) + s(SST_May_July, k=4),
              data = dat, correlation=corAR1())
#Model summaries
summary(mod24)
summary(mod24$gam)
...
mod25 <- gamm(logRS ~ s(ReproductiveFemales, k=4) + s(FHS_lag2, k=4) + s(Ovig_female_CO, k=4)+ s(SE.wind, k=4),
              data = dat, correlation=corAR1())
#Model summaries
summary(mod25)
summary(mod25$gam)
...
mod26 <- gamm(logRS ~ s(ReproductiveFemales, k=4) + s(FHS_lag2, k=4) + s(Ovig_female_CO, k=4)+ s(NE.wind, k=4),
              data = dat, correlation=corAR1())
#Model summaries
summary(mod26)
summary(mod26$gam)
...
###################################################### Combine FHS lag 2 + PDO_RA3 #####################################################
mod27 <- gamm(logRS ~ s(ReproductiveFemales, k=4) + s(FHS_lag2, k=4) + s(PDO_RA3, k=4),
              data = dat, correlation=corAR1())
#Model summaries
summary(mod27)
summary(mod27$gam)
...
###################################################### Combine FHS lag 2 + AO_RA3 #####################################################
mod28 <- gamm(logRS ~ s(ReproductiveFemales, k=4) + s(FHS_lag2, k=4) + s(AO_RA3, k=4),
              data = dat, correlation=corAR1())
#Model summaries
summary(mod28)
summary(mod28$gam)
...
mod29 <- gamm(logRS ~ s(ReproductiveFemales, k=4) + s(FHS_lag2, k=4) + s(PDO_RA2, k=4),
              data = dat, correlation=corAR1())
#Model summaries
summary(mod29)
summary(mod29$gam)
...
mod30 <- gamm(logRS ~ s(ReproductiveFemales, k=4) + s(FHS_lag2, k=4) + s(AO_RA2, k=4),
              data = dat, correlation=corAR1())
#Model summaries
summary(mod30)
summary(mod30$gam)
...
mod31 <- gamm(logRS ~ s(ReproductiveFemales, k=4) + s(FHS_lag2, k=4) + s(SST_May_July, k=4),
              data = dat, correlation=corAR1())
#Model summaries
summary(mod31)
summary(mod31$gam)
...
mod32 <- gamm(logRS ~ s(ReproductiveFemales, k=4) + s(FHS_lag2, k=4) + s(SE.wind, k=4),
              data = dat, correlation=corAR1())
#Model summaries
summary(mod32)
summary(mod32$gam)
...
mod33 <- gamm(logRS ~ s(ReproductiveFemales, k=4) + s(FHS_lag2, k=4) + s(PDO_RA3, k=4)+ s(AO_RA3, k=4),
              data = dat, correlation=corAR1())
#Model summaries
summary(mod33)
summary(mod33$gam)
...
mod34 <- gamm(logRS ~ s(ReproductiveFemales, k=4) + s(FHS_lag2, k=4) + s(PDO_RA2, k=4)+ s(AO_RA2, k=4),
              data = dat, correlation=corAR1())
#Model summaries
summary(mod34)
summary(mod34$gam)
...
AICc_GAMM<-MuMIn::AICc(mod1,mod2,mod3,mod4, mod5,mod6,mod7,mod8,mod9,mod10,mod11,mod12,mod13,mod14,mod15,mod16,mod17,mod18,mod19,mod20,mod21,mod22,mod23,mod24,mod25,mod26,mod27,mod28,mod29,mod30,mod31,mod32,mod33,mod34)

write.csv(AICc_GAMM,"output/GAMM_effect_only_AICc_values.csv")


#### MODEL TEST

###################################################### Combine FHS lag 2, AO_RA2 + PDO_RA2 #####################################################
mod_test <- gamm(logRS ~ s(ReproductiveFemales, k=4) + s(FHS_lag2, k=4) + s(PDO_RA2, k=4)+ s(AO_RA2, k=4)+ s(SST_May_July, k=4),
              data = dat, correlation=corAR1())
#Model summaries
summary(mod_test)
