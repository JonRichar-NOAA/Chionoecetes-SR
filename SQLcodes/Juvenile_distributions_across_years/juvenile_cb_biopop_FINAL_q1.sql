...
(CASE
	 ...
	 then ((sqrt(sum_varbio_female_le60))/sum_biofe_male_le60)
	 else 0
...
drop table cbairdi_juvenile_biomass;

create table cbairdi_juvenile_biomass as
select a.survey_year,
...
drop table cbairdi_juvenile_abundance;

create table cbairdi_juvenile_abundance as
select a.survey_year,
...
drop table cb_w166_bio_matfem_newregress;

create table cb_w166_bio_matfem_newregress as
select a.survey_year,
...
drop table cb_w166_pop_matfem_newregress;

create table cb_w166_pop_matfem_newregress as
select a.survey_year,
