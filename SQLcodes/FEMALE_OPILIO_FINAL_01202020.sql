 ...
 (sum(CASE
  ...
  (sum(CASE
         ...
         AND    shell_condition = 2
				   THEN number_female_size1
				ELSE 0
				END))  number_female_size1_prim,
  (sum(CASE
	   			WHEN   clutch_size >= 1 
          AND    shell_condition >= 3
				   THEN number_female_size1
				ELSE 0
				END))  number_female_size1_mult
    from co_number_size1_female
    where species_code = 68580
		 --and width <> 999
...
(sum(CASE
    ...
    (sum(CASE
          ...
          AND shell_condition = 2
				   THEN wgt_female_size1
				ELSE 0
				END))  wgt_female_size1_prim,
    (sum(CASE
	   			WHEN   clutch_size >= 1 
          AND shell_condition >= 3
				   THEN wgt_female_size1
				ELSE 0
				END))  wgt_female_size1_mult
...
( HAULJOIN                        NUMBER(12),
  ...
  WGT_FEMALE_SIZE1_PRIM           NUMBER,
  WGT_FEMALE_SIZE1_MULT           NUMBER
);
...
wgt_female_size1_full,wgt_female_size1_sc2,wgt_female_size1_sc3,wgt_female_size1_sc4,wgt_female_size1_sc5,wgt_female_size1_prim,wgt_female_size1_mult
...
(wgt_female_size1_prim * 0.000001) mt_female_size1_prim,
(wgt_female_size1_mult * 0.000001) mt_female_size1_mult
...
( HAULJOIN                        NUMBER(12),
  ...
  NUMBER_FEMALE_SIZE1_PRIM        NUMBER,
  NUMBER_FEMALE_SIZE1_MULT         NUMBER
);
insert into co_number_size1
select hauljoin,vessel,cruise,haul,gis_station,species_code,size1,shell_condition,
number_male_size1,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null
from co_number_size1_male;
...
number_female_size1_ovig,number_female_size1_trace,number_female_size1_quarter,
number_female_size1_half,number_female_size1_three_qrt,number_female_size1_full,
number_female_size1_sc2,number_female_size1_sc3,number_female_size1_sc4,number_female_size1_sc5,
number_female_size1_prim,number_female_size1_mult
from co_number_size1_matfem;

/*
insert into co_number_size1
select hauljoin,vessel,cruise,haul,gis_station,species_code,size1,null,
null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,number_unsexed_size1
...
select hauljoin, vessel, cruise, haul, gis_station, species_code, 
     ...
     sum(number_female_size1_prim) number_female_prim,
     sum(number_female_size1_mult) number_female_mult,
...
select hauljoin, vessel, cruise, haul, gis_station, species_code, 
     ...
     sum(mt_female_size1_prim) mt_female_prim,
     sum(mt_female_size1_mult) mt_female_mult,
...
nvl(number_female_prim,0) number_female_prim,
nvl(number_female_mult,0) number_female_mult
...
nvl(mt_female_prim,0) mt_female_prim,
nvl(mt_female_mult,0) mt_female_mult,
...
(number_female_prim / (((net_width/1000) * distance_fished) * 0.29155335)) female_cpuenum_prim,
(number_female_mult / (((net_width/1000) * distance_fished) * 0.29155335)) female_cpuenum_mult,
...
drop table co_ebs_male_female_grps_cpuenum;
create table co_ebs_male_female_grps_cpuenum as select * from co_cpuenum_sizegroup;

drop table co_ebs_female_sc3plus_anbi_cpuenum;

create table co_ebs_female_sc3plus_anbi_cpuenum as
select hauljoin,vessel,cruise,haul,latitude,longitude,
gis_station,survey_year,species_code,(female_cpuenum_sc3+female_cpuenum_sc4 + female_cpuenum_sc5) female_cpuenum_sc3plus,
((female_cpuenum_sc3+female_cpuenum_sc4 + female_cpuenum_sc5)*401)female_abundance_sc3plus
from co_cpuenum_sizegroup 
where cruise in (201401,201501,201601,201701,201801);

drop table co_ebs_female_sc3plus_anbi_cpuenum_2014;

create table co_ebs_female_sc3plus_anbi_cpuenum_2014 as
select * from co_ebs_female_sc3plus_anbi_cpuenum
where cruise =201401
and gis_station in ('I-20','I-19','J-20','M-27','O-27','O-28','S-27','T-25','U-28');

drop table co_ebs_female_sc3plus_anbi_cpuenum_2015;

create table co_ebs_female_sc3plus_anbi_cpuenum_2015 as
select * from co_ebs_female_sc3plus_anbi_cpuenum
where cruise =201501
and gis_station in ('B-06','D-03','D-02','E-02','E-19','F-18','F-19','GF1918','I-25','L-29','M-26','M-23','O-27','O-24','PO2423','P-23','Q-26','R-26','R-32','R-27','S-25','U-29','U-28');

drop table co_ebs_female_sc3plus_anbi_cpuenum_2016;

create table co_ebs_female_sc3plus_anbi_cpuenum_2016 as
select * from co_ebs_female_sc3plus_anbi_cpuenum
where cruise =201601
and gis_station in ('D-04','D-01','F-18','F-23','F-01','H-24','I-24','M-26','O-24','R-26','T-28','V-26','V-27');

drop table co_ebs_female_sc3plus_anbi_cpuenum_2017;

create table co_ebs_female_sc3plus_anbi_cpuenum_2017 as
select * from co_ebs_female_sc3plus_anbi_cpuenum
where cruise =201701
and gis_station in ('F-23','GF1918','G-24','G-19','I-24','J-25','J-23','K-23','L-23','O-28','QP2625','Q-23','S-28','S-29','U-26','V-25');

drop table co_ebs_female_sc3plus_anbi_cpuenum_2018;

create table co_ebs_female_sc3plus_anbi_cpuenum_2018 as
select * from co_ebs_female_sc3plus_anbi_cpuenum
where cruise =201801
and gis_station in ('E-18','F-18','F-19','GF1918','G-18','I-24','I-23','I-25','JI2221','K-24','L-24','L-18','M-19','N-24','Q-23','R-26','T-29','T-27');
...
(mt_female_prim / (((net_width/1000) * distance_fished) * 0.29155335)) female_cpuewgt_prim,
(mt_female_mult / (((net_width/1000) * distance_fished) * 0.29155335)) female_cpuewgt_mult,
...
AVG (female_cpuenum_prim) meancpuenum_female_prim,
AVG (female_cpuenum_mult) meancpuenum_female_mult,
AVG (female_cpuenum_total) meancpuenum_female_total,
AVG (male_cpuenum_total + female_cpuenum_total) meancpuenum_gtotal
...
AVG (female_cpuewgt_prim) meancpuewgt_female_prim,
AVG (female_cpuewgt_mult) meancpuewgt_female_mult,
...
select distinct c.survey_year,stratum,c.district,
 ...
 (meancpuenum_female_prim * total_area) pop_female_prim,
 (meancpuenum_female_mult * total_area) pop_female_mult,
...
(meancpuewgt_female_prim * total_area) bio_female_prim,
(meancpuewgt_female_mult * total_area) bio_female_mult,
...
VARIANCE (female_cpuenum_prim) varcpuenum_female_prim,
VARIANCE (female_cpuenum_mult) varcpuenum_female_mult,
VARIANCE (female_cpuenum_total) varcpuenum_female_total,
VARIANCE (male_cpuenum_total + female_cpuenum_total) varcpuenum_gtotal
from co_cpuenum_sizegroup c, strata_opilio_newtimeseries s
where c.gis_station = s.station_id
and c.survey_year = s.survey_year
group by c.survey_year,district;
...
VARIANCE (female_cpuewgt_prim) varcpuewgt_female_prim,
VARIANCE (female_cpuewgt_mult) varcpuewgt_female_mult,
...
((varcpuenum_female_prim * (power(total_area,2)))/number_tows) varpop_female_prim,
((varcpuenum_female_mult * (power(total_area,2)))/number_tows) varpop_female_mult,
...
((varcpuewgt_female_prim * (power(total_area,2)))/number_tows) varbio_female_prim,
((varcpuewgt_female_mult * (power(total_area,2)))/number_tows) varbio_female_mult,
...
sum(pop_female_prim) sum_pop_female_prim,
sum(pop_female_mult) sum_pop_female_mult,
...
sum(bio_female_prim) sum_bio_female_prim,
sum(bio_female_mult) sum_bio_female_mult,
...
sum(varpop_female_prim) sum_varpop_female_prim,
sum(varpop_female_mult) sum_varpop_female_mult,
...
sum(varbio_female_prim) sum_varbio_female_prim,
sum(varbio_female_mult) sum_varbio_female_mult,
...
(CASE
	 when sum_pop_female_prim <> 0
	 then ((sqrt(sum_varpop_female_prim))/sum_pop_female_prim)
	 else 0
	 end) cv_pop_female_prim,
(CASE
	 when sum_pop_female_mult <> 0
	 then ((sqrt(sum_varpop_female_mult))/sum_pop_female_mult)
	 else 0
	 end) cv_pop_female_mult,
(CASE
...
(CASE
	 when sum_bio_female_prim <> 0
	 then ((sqrt(sum_varbio_female_prim))/sum_bio_female_prim)
	 else 0
	 end) cv_bio_female_prim,
(CASE
	 when sum_bio_female_mult <> 0
	 then ((sqrt(sum_varbio_female_mult))/sum_bio_female_mult)
	 else 0
	 end) cv_bio_female_mult,	
(CASE
...
(sqrt(sum_varpop_female_prim)) stderr_pop_female_prim,
(sqrt(sum_varpop_female_mult)) stderr_pop_female_mult,
...
(1.96 * stderr_pop_female_prim) ci_pop_female_prim,
(1.96 * stderr_pop_female_mult) ci_pop_female_mult,
...
(sqrt(sum_varbio_female_prim)) stderr_bio_female_prim,
(sqrt(sum_varbio_female_mult)) stderr_bio_female_mult,
...
((1.96 * stderr_bio_female_prim)) ci_bio_female_prim,
((1.96 * stderr_bio_female_mult)) ci_bio_female_mult,
...
drop table co_male_female_group_bio_EBS;

create table co_male_female_group_bio_EBS as
select a.survey_year,
...
sum_bio_female_prim biomass_female_prim,cv_bio_female_prim cv_biomass_female_prim,ci_bio_female_prim ci_biomass_female_prim,
sum_bio_female_mult biomass_female_mult,cv_bio_female_mult cv_biomass_female_mult,ci_bio_female_mult ci_biomass_female_mult,
...
drop table co_male_female_group_abun_EBS;

create table co_male_female_group_abun_EBS as
select a.survey_year,
...
sum_pop_female_prim num_female_prim,cv_pop_female_prim cv_num_female_prim,ci_pop_female_prim ci_num_female_prim,
sum_pop_female_mult num_female_mult,cv_pop_female_mult cv_num_female_mult,ci_pop_female_mult ci_num_female_mult,
